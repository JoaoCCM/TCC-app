...
import { View, Text, TouchableOpacity, Image, FlatList, PanResponder, Animated } from "react-native";
...
class Favorites extends React.Component {
    ...
    yToIndex = y => {
        Math.floor((this.scrollOffset + y - this.flatListTopOffset) / this.rowHeight);
    }
